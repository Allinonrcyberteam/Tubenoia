...
Imports System.IO
Public Class frmRetrieveSubscribers
    Dim F As New Functions.General
    Private Sub frmRetrieveSubscribers_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Resize
...
Start:      HTML = W.httpGet(String.Format("http://www.youtube.com/profile?user={0}&view=subscribers&start={1}&persist_hl=1&hl=en", Stuff(0), Start))
    ...
    Private Sub MenuItem2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem2.Click
        ...
        SD.Filter = "Tubenoia Subscribers List (*.TNSL)|*.TNSL"
        SD.FilterIndex = 1
        SD.Title = "Export Subscriber List"
        If Not txtChannel.Text = "" Then
            SD.FileName = txtChannel.Text & "_subscribers.TNSL"
        Else
            SD.FileName = "Subscribers.TNSL"
        End If
        If SD.ShowDialog = DialogResult.OK Then
            ...
            For Each itm As ListViewItem In lstSubscribers.Items
                stuff.Add(itm)
            Next
            binFormat.Serialize(fStream, stuff)
            F.Logs("Subscriber Scraper list exported to " & SD.FileName, 2, frmLog.IL, frmLog.Log)
            fStream.Close()
        End If
    End Sub
    Private Sub MenuItem4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem4.Click
        ...
        For Each itm As ListViewItem In lstSubscribers.Items
            If itm.Index = lstSubscribers.Items.Count - 1 Then
                S.Append(itm.Text)
            Else
        ...
        SD.Title = "Export Subscriber List"
        If Not txtChannel.Text = "" Then
            SD.FileName = txtChannel.Text & "_subscribers.txt"
        Else
            SD.FileName = "Subscribers.txt"
        End If
        If SD.ShowDialog = DialogResult.OK Then
    ...
    Private Sub MenuItem5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem5.Click
        For Each itm As ListViewItem In lstSubscribers.SelectedItems
            itm.Remove()
        Next
    End Sub
End Class